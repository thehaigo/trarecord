defmodule TrarecordWeb.ItemLiveTest do
  use TrarecordWeb.ConnCase

  import Phoenix.LiveViewTest
  import Trarecord.ItemsFixtures

  @create_attrs %{category: "some category", image: "some image", name: "some name", status: true, url: "some url"}
  ...
  @invalid_attrs %{category: nil, image: nil, name: nil, status: false, url: nil}
