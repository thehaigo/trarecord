defmodule TrarecordWeb.UserAuth do
  ...
  the current_user:
      ...
      defmodule TrarecordWeb.PageLive do
        ...
        on_mount {TrarecordWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{TrarecordWeb.UserAuth, :ensure_authenticated}] do
