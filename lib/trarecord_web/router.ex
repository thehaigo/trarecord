defmodule TrarecordWeb.Router do
  ...
  import TrarecordWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {TrarecordWeb.Layouts, :root}
  ...
  # scope "/api", TrarecordWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:trarecord, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: TrarecordWeb.Telemetry
  ...
  scope "/", TrarecordWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TrarecordWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TrarecordWeb do
    ...
    live_session :current_user,
      on_mount: [{TrarecordWeb.UserAuth, :mount_current_user}] do
